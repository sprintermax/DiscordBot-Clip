...
module.exports = async (client, member) => {
	...
	var embed = new Discord.MessageEmbed()
		...
		.addField(`­`, `**Canais de Notícias:**\nSe você procura por informações sobre o jogo, como anúncios em geral, notas de atualização, modo competitivo e criativo, existem os chats da categoria **Fortnite Notícias**, como o [#Anúncios](https://discordapp.com/channels/499203081209118720/499233260103008266) e o [#Status-Do-Jogo](https://discordapp.com/channels/499203081209118720/499233323403575328).\n\nAtualizações do servidor, como alterações em cargos, notícias sobre o Discord e mudança de regras são avisadas no chat [#Discord-Notícias](https://discordapp.com/channels/499203081209118720/499236638245912586).`)
